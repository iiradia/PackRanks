                    ...
                    <div id="termDivLabel" class="text-center">
                        ...
                        <div id="termDiv">
                            <select id="whichterm" name="whichterm" class="bg-light" onChange={this.setTerm}>
                                ...
                                <option value="2021 Fall Term">2021 Fall Term</option>
                                <option value="2021 Summer Session 2">2021 Summer Session 2</option>
                                <option value="2021 Summer Session 1">2021 Summer Session 1</option>
                                <option value="2021 Spring Term">2021 Spring Term</option>
                                <option value="2020 Fall Term">2020 Fall Term</option>
                                <option value="2020 Summer Term 2">2020 Summer Session 2</option>
                                <option value="2020 Summer Term 1">2020 Summer Session 1</option>
                            </select>
                        </div>
                    </div>
                </div>
