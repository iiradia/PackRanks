                ...
                <div id="container" class="container">
                    <div id="aboutDiv" class="row">
                            <div class="about-title clearfix">
                                ...
                                <h6 id="aboutPack">
                                    <h6 id="aboutPack" class="about-paddingB">We take the thinking out of the equation, just do! We use newly updated data from <span id="bolderGradient">Wolftech Gradient</span> to compute a rating of each course that measures how easy or difficult the class is. We then sort our course results for GEPs and specific courses by that rating, providing you with a simple and effective way to find the easiest GEPs or any courses you are looking for!
                                    </h6>
